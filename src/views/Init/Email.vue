<template>
  <Card style="width: 50rem">
    ...
    <template #content>
      <template v-if="!exist">
        <p>Добавьте первый домен почты. Только с разрешенных доменов пользователи имеют право регистрироваться и заходить в систему. После настройки системы откроется меню почтовых доменов.</p>
