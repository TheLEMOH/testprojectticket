<template>
    <Filter :search="state" redirect="userAll">
        ...
        <template #content>
            ...
            <Dropdown v-model="state.organizationId" :options="organizations" optionLabel="name" optionValue="id" filter
                placeholder="Организация"></Dropdown>
            ...
            <Dropdown v-model="state.roleId" :options="roles" optionLabel="name" optionValue="id" filter placeholder="Роль">
            </Dropdown>
